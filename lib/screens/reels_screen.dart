          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                const Icon(Icons.send, color: AppColorConst.appWhite, size: 24),
                const SizedBox(height: 20),
                IconButton(
                  onPressed: () {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text(
                        'Follow',
                        style: TextStyle(
                            color: AppColorConst.appWhite, fontSize: 12),
                      ),
                    ),
                  ],
                ),
                ...
                const Row(
                  children: [
                    Icon(Icons.music_note,
                        size: 16, color: AppColorConst.appWhite),
                    SizedBox(width: 5),
                    Text(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border:
                            Border.all(color: AppColorConst.appWhite, width: 2),
                      ),
                      child: Image.asset(
                        AppImageConst.appNature,
                        fit: BoxFit.cover,
