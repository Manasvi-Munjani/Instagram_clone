...
class PostDetailsScreen extends StatefulWidget {
  ...
  const PostDetailsScreen({super.key, required this.posts, required this.initialIndex});
...
class _PostDetailsScreenState extends State<PostDetailsScreen> {
  ...
  // Assuming each item height approx 350 (adjust to your UI)
  final double _itemHeight = 350;
  ...
  void initState() {
    ...
    // Wait for the frame to build before jumping
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _scrollController.jumpTo(widget.initialIndex * _itemHeight);
    });
  }
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return SizedBox(
            height: _itemHeight, // Fix height for accurate scroll offset
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
